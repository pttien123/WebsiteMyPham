...
<div class="wrapper">
  	<div class="widget">
      		<div class="title">
        			<h6>Chỉnh sửa Đơn vị (tính/ khối lượng) của sản phẩm</h6>
      		</div>
          <form class="form" id="form" action="" method="post" enctype="multipart/form-data">
			         <fieldset>
                 <!--Hàng username-->
                      <div class="formRow">
                              <label class="formLeft" for="param__tenDV">
                                  Tên đơn vị:<span class="req">*</span>
                              </label>
                              <div class="formRight">
                                  <span class="oneTwo">
                                      <input name="tenDV" id="param_tenDV" _autocheck="true" type="text" value="<?php echo $info->TenDV ?>"/>
                                  </span>
