                 ...
                 <div class="formRow">
                           ...
                           <?php foreach ($catalog as $row):?>
                                  ...
                                  <optgroup label="<?php echo $row->TenDM ?>">
                                    <?php foreach ($row->product as $product): ?>
                                           <option value="<?php echo $product->MaSP ?>" <?php if($this->input->get('sanpham') == $product->MaSP) echo 'selected';?>>
                   ...
                   <div class="clear"></div>
                      ...
                      <div class="formRow">
                             ...
                             <div class="formRight">
                                   <span class="oneTwo">
                                       <input name="HSD" id="param_HSD" _autocheck="true" type="date" value="<?php echo set_value('HSD') ?>"/>
                                   </span>
                       ...
                       <!--Hàng Ngày nhập-->
                            <div class="formRow">
                                    ...
                                    <div class="formRight">
                                        <span class="oneTwo">
                                            <input name="ngayNhap" id="param_ngayNhap" _autocheck="true" type="date" value="<?php echo set_value('ngayNhap') ?>"/>
                                        </span>
                                        <span name="name_autocheck" class="autocheck"></span>
                       ...
                       <!--Hàng số lượng nhập-->
                            <div class="formRow">
                                    ...
                                    <div class="formRight">
                                        <span class="oneTwo">
                                            <input name="SLNhap" id="param_SLNhap" _autocheck="true" type="number" value="<?php echo set_value('SLNhap') ?>"/>
                                        </span>
                                        <span name="name_autocheck" class="autocheck"></span>
