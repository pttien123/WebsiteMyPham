...
<div class="wrapper">
  	<div class="widget">
      		<div class="title">
        			<h6>Thêm mới Nhãn Hiệu Sản Phẩm</h6>
      		</div>
          <form class="form" id="form" action="" method="post" enctype="multipart/form-data">
			         <fieldset>
                 <!--Hàng username-->
                      <div class="formRow">
                              <label class="formLeft" for="param_tenNH">
                                  Tên nhãn hiệu:<span class="req">*</span>
                              </label>
                              <div class="formRight">
                                  <span class="oneTwo">
                                      <input name="tenNH" id="param_tenNH" _autocheck="true" type="text" value="<?php echo set_value('tenNH') ?>"/>
                                  </span>
